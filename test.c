...
/*   Updated: 2022/06/20 23:49:27 by ababouel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     char **cmd[] = {ls, grep, wc, NULL};
    ...
    char *str2[100] = {"file1.txt", "file3.txt", "file2.txt"}; 
    ...
    cmdredirectinput(str2,str1,env, O_WRONLY | O_CREAT |O_TRUNC , STDOUT_FILENO);
    return (0); 
}